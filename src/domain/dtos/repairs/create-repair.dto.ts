...
const createRepairSchema = z.object({
  date: z.string({ message: "date is required" })
    ...
    .refine((date) => {
      ...
      return parsedDate.getMonth() === month - 1 &&
...
export class CreateRepairDTO {
  constructor(public date: Date, public userId: string, public motorsNumber: string, public description: string) { }
